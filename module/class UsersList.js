...
class User{
  ...
  async getfollowMessage(){
    ...
    //●メッセージ作成
    //利用規約も作成し役員レビュー後公開しました
    //LINE公式アカウントの利用規約として総務省のアカウントなどを参考にしました
    //「利用規約に同意する」ボタンを押さないとサービスが利用できないようになっています
    let textMessage = "oooLINE公式アカウントのご利用ありがとうございます。\n" +
    "当公式アカウントでは、希少・少量で完売スピードの速い商品や、注文のみ対応の商品などを中心に、随時ご案内いたします。\n\n" +

    "当公式アカウントのご利用は、ooo株式会社と売買取引基本契約を結んでいる買参人様に限らせていただきます。\n" +
    "以下のURLより、「ooo公式アカウント サービス利用規約」を一読、同意ください。\n" +
    "https://xxxx\n\n" +
